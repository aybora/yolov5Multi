...
class YoloTime2D(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(768, 2304, kernel_size=3, padding=1, stride=1)
        self.conv2 = nn.Conv2d(2304, 1024, kernel_size=1, padding=0, stride=1)
        self.conv3 = nn.Conv2d(1024, 512, kernel_size=3, padding=1, stride=1)
        self.conv4 = nn.Conv2d(512, 1024, kernel_size=1, padding=0, stride=1)
        self.conv5 = nn.Conv2d(1024, 512, kernel_size=3, padding=1, stride=1)
        self.conv6 = nn.Conv2d(512, 256, kernel_size=1, padding=0, stride=1)
        self.conv7 = nn.Conv2d(256, 512, kernel_size=3, padding=1, stride=1)
        self.conv8 = nn.Conv2d(512, 256, kernel_size=1, padding=0, stride=1)
        #self.conv4 = nn.Conv2d(1024, 18, kernel_size=1, stride=1)
        
        self.bn1 = nn.BatchNorm2d(2304, momentum=0.03, eps=1e-3)
        ...
        self.bn7 = nn.BatchNorm2d(512, momentum=0.03, eps=1e-3)
        self.bn8 = nn.BatchNorm2d(256, momentum=0.03, eps=1e-3)
