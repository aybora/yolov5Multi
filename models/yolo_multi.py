...
class YoloTime2D(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(1024, 3072, kernel_size=3, padding=1, stride=1)
        self.conv3 = nn.Conv2d(3072, 1024, kernel_size=1, padding=0, stride=1)
        self.conv4 = nn.Conv2d(1024, 512, kernel_size=3, padding=1, stride=1)
        ...
        self.conv9 = nn.Conv2d(512, 256, kernel_size=1, padding=0, stride=1)
        #self.conv4 = nn.Conv2d(1024, 18, kernel_size=1, stride=1)
        
        self.bn1 = nn.BatchNorm2d(1024, momentum=0.03, eps=1e-3)
        self.bn2 = nn.BatchNorm2d(3072, momentum=0.03, eps=1e-3)
        ...
        self.bn7 = nn.BatchNorm2d(256, momentum=0.03, eps=1e-3)
        self.bn8 = nn.BatchNorm2d(512, momentum=0.03, eps=1e-3)
        self.bn9 = nn.BatchNorm2d(256, momentum=0.03, eps=1e-3)
